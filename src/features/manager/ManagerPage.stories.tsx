...
export const HappyPath: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.findByText('Manager Queue')).resolves.toBeInTheDocument();
...
export const BalanceChangedBeforeApproval: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(
      canvas.findByText(/Balance changed since one or more requests were submitted/i),
...
export const HcmErrorOnApproval: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.findByRole('button', { name: 'Approve' })).resolves.toBeInTheDocument();
